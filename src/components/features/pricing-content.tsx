...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    cta: "Claim Your Spot",
    features: [
      { label: "Same as Pro", included: true },
      { label: "Discounted price locked forever", included: true },
...
export function PricingContent() {
  ...
  async function handleManageBilling() {
    if (!pendingPlan) return;
    try {
      const returnTo = `${pathname}?confirmPlan=${pendingPlan.key}&confirmInterval=${pendingPlan.interval}`;
